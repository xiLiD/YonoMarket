...
Page({
  ...
  onLoad: function (options) {
    ...
    login.login().then(res => {
      ...
      _this.setData({ rels: options.rels, colorSizeId: options.colorSizeId ? options.colorSizeId : '', cartJSONStr: options.cartJSONStr ? options.cartJSONStr : ''})
      if (options) {
        let page = '',
          type = '',
          typeVal = '',
  ...
  toDetails(e){
    ...
    console.log(JSON.parse(_this.data.rels))
    console.log(JSON.parse(_this.data.cartJSONStr))
    // wx.redirectTo({
    //   url: '/pages/qrdd/qrdd'
    // })
    if(_this.data.colorSizeId){
      wx.redirectTo({
        url: '/pages/qrdd/qrdd/?rels=' + _this.data.rels + ' & colorSizeId=' + _this.data.colorSizeId + '&couponId=' + id
      })
    }else {
      wx.redirectTo({
        url: '/pages/qrdd/qrdd/?rels=' + _this.data.rels + ' & cartJSONStr=' + JSON.parse_this.data.cartJSONStr + '&couponId=' + id
      })
    }
