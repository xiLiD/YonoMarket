...
const app = getApp();
var WxParse = require('../../components/wxParse/wxParse.js'); //解析富文本
...
Page({
  ...
  onLoad: function(options) {
      ...
      tool.loading();
      Promise.all([_this.findCulture('品牌介绍', 1, _this.data.list[0].page), _this.findCulture('视频介绍', 2, _this.data.list[1].page), _this.findCulture('潮流文化', 3, _this.data.list[2].page),_this.getBanner()]).then((res)=>{
        tool.loading_h();
      })
