...
Page({
  ...
  tobookOrder() {
    ...
    tool.jump_nav('/pages/bookOrder/bookOrder?address=' + address + '&details=' + details + '&name=' + wx.getStorageSync('userInfo').nickName + '&phone=' + wx.getStorageSync('mobile') + '&time=' +
